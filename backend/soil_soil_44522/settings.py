"""
Django settings for soil_soil_44522 project.
...
ROOT_URLCONF = 'soil_soil_44522.urls'
...
WSGI_APPLICATION = 'soil_soil_44522.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soil_soil_44522 API",
    "DESCRIPTION": "API documentation for soil_soil_44522 App",
    "VERSION": "v1",
}
